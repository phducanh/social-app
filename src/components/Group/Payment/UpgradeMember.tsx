        ...
        <div className=" mt-5 mx-5">
          <div aria-label="" className=" ">
            <Form
              ...
              onFinish={submitForm}
            >
              <span className="font-bold">Chọn loại thành viên:</span>
              <Form.Item
                name="radio-group"
                  ...
                  >
                    <Space direction="vertical" className=" my-1">
                      <Radio
                        value={1}
                        disabled={
                          userData?.member_type == "member" ? true : false
                        }
                        ...
                        <div>
                          <div className="font-bold text-base flex justify-start">
                            ...
                            <div
                              ...
                              hidden={
                                userData?.member_type == "member" ? false : true
                              }
                              className="ml-2 mt-[2px] h-[15px] w-[15px]"
                            >
                              <img
                                src="/images/icons/green-check-fill.png"
                                alt=""
                              />
                            </div>
                          </div>
                          <div className="text-sm">
                            Bạn có thể xem, tương tác, bình luận bài viết nhưng
                            không thể đăng bài
                          </div>
                        </div>
                      </Radio>
                      <Radio value={2}>
                        <div>
                          ...
                          <div className="text-sm">
                            Bạn có thể xem, tương tác, bình luận bài viết và có
                            thể viết bài đóng góp đồng thời kiếm thêm thu nhập
                          </div>
                        </div>
                      </Radio>
                    </Space>
            ...
            >
              ...
              <div className="bg-[#CCFFCC] border-solid border-2 rounded-xl p-2">
                <div className="font-bold text-base flex justify-start">
                ...
                <div className="text-sm">
                  Bạn có thể xem, tương tác, bình luận bài viết và có thể viết
                  bài đóng góp đồng thời kiếm thêm thu nhập
                </div>
              </div>
